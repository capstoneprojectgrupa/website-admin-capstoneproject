...
// NEW ONE PRODUCE USING CHAT GPT
...
//             setLoading(true);
//             if (initialData) {
//                 await axios.patch(`/api/${params.storeId}/banners/${initialData.id}`, data);
//             } else {
//                 await axios.post(`/api/${params.storeId}/banners`, data);
//             }
//             router.refresh();
...
//         try {
//             setLoading(true);
//             await axios.delete(`/api/${params.storeId}/banners/${initialData?.id}`);
//             router.refresh();
//             router.push('/');
//             toast.success("Banner berhasil dihapus");
//         } catch (error) {
